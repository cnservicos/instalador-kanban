...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do WhatsApp...${GRAY_LIGHT}"
  printf "\n\n"
